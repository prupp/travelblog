...
class CommentTableMap extends TableMap
{
    ...
    /**
     * the column name for the entryid field
     */
    const COL_ENTRYID = 'comment.entryid';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Date', 'Time', 'Text', 'Userid', 'Entryid', ),
        self::TYPE_CAMELNAME     => array('id', 'date', 'time', 'text', 'userid', 'entryid', ),
        self::TYPE_COLNAME       => array(CommentTableMap::COL_ID, CommentTableMap::COL_DATE, CommentTableMap::COL_TIME, CommentTableMap::COL_TEXT, CommentTableMap::COL_USERID, CommentTableMap::COL_ENTRYID, ),
        self::TYPE_FIELDNAME     => array('id', 'date', 'time', 'text', 'userid', 'entryid', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Date' => 1, 'Time' => 2, 'Text' => 3, 'Userid' => 4, 'Entryid' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'date' => 1, 'time' => 2, 'text' => 3, 'userid' => 4, 'entryid' => 5, ),
        self::TYPE_COLNAME       => array(CommentTableMap::COL_ID => 0, CommentTableMap::COL_DATE => 1, CommentTableMap::COL_TIME => 2, CommentTableMap::COL_TEXT => 3, CommentTableMap::COL_USERID => 4, CommentTableMap::COL_ENTRYID => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'date' => 1, 'time' => 2, 'text' => 3, 'userid' => 4, 'entryid' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('entryid', 'Entryid', 'INTEGER', 'entry', 'id', false, 10, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Entry', '\\Entry', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':entryid',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentTableMap::COL_TIME);
            $criteria->addSelectColumn(CommentTableMap::COL_TEXT);
            $criteria->addSelectColumn(CommentTableMap::COL_USERID);
            $criteria->addSelectColumn(CommentTableMap::COL_ENTRYID);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.entryid');
        }
    }
