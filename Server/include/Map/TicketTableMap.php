...
class TicketTableMap extends TableMap
{
     ...
     */
    const COL_USERID = 'ticket.userid';

    /**
     * the column name for the expires field
     */
    const COL_EXPIRES = 'ticket.expires';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Userid', 'Expires', ),
        self::TYPE_CAMELNAME     => array('id', 'userid', 'expires', ),
        self::TYPE_COLNAME       => array(TicketTableMap::COL_ID, TicketTableMap::COL_USERID, TicketTableMap::COL_EXPIRES, ),
        self::TYPE_FIELDNAME     => array('id', 'userid', 'expires', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Userid' => 1, 'Expires' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'userid' => 1, 'expires' => 2, ),
        self::TYPE_COLNAME       => array(TicketTableMap::COL_ID => 0, TicketTableMap::COL_USERID => 1, TicketTableMap::COL_EXPIRES => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'userid' => 1, 'expires' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('id', 'Id', 'VARCHAR', true, 16, null);
        $this->addForeignKey('userid', 'Userid', 'INTEGER', 'user', 'id', true, 10, null);
        $this->addColumn('expires', 'Expires', 'VARCHAR', false, 45, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TicketTableMap::COL_USERID);
            $criteria->addSelectColumn(TicketTableMap::COL_EXPIRES);
        } else {
