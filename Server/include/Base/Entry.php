...
abstract class Entry implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EntryTableMap';
    ...
    /**
     * The value for the travelid field.
     * @var        int
     */
    protected $travelid;
    ...
    /**
     * Initializes internal state of Base\Entry object.
     */
     ...
     * @return $this|\Entry The current object (for fluent API support)
     */
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[EntryTableMap::COL_TITLE] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d") !== $this->date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[EntryTableMap::COL_DATE] = true;
            }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== null || $dt !== null) {
            if ($this->time === null || $dt === null || $dt->format("H:i:s") !== $this->time->format("H:i:s")) {
                $this->time = $dt === null ? null : clone $dt;
                $this->modifiedColumns[EntryTableMap::COL_TIME] = true;
            }
        } // if either are not null
    ...
    public function setLocation($v)
    {
        ...
        if ($this->location !== $v) {
            $this->location = $v;
            $this->modifiedColumns[EntryTableMap::COL_LOCATION] = true;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[EntryTableMap::COL_TEXT] = true;
        }
    ...
    public function setImage($v)
    {
        ...
        if ($this->image !== $v) {
            $this->image = $v;
            $this->modifiedColumns[EntryTableMap::COL_IMAGE] = true;
        }
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[EntryTableMap::COL_USERID] = true;
        }
    ...
    /**
     * Set the value of [travelid] column.
     *
     * @param int $v new value
     * @return $this|\Entry The current object (for fluent API support)
     */
    public function setTravelid($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->travelid !== $v) {
            $this->travelid = $v;
            $this->modifiedColumns[EntryTableMap::COL_TRAVELID] = true;
        }

        if ($this->aTravel !== null && $this->aTravel->getId() !== $v) {
            $this->aTravel = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EntryTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EntryTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EntryTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EntryTableMap::translateFieldName('Location', TableMap::TYPE_PHPNAME, $indexType)];
            $this->location = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EntryTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
            $this->text = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : EntryTableMap::translateFieldName('Image', TableMap::TYPE_PHPNAME, $indexType)];
            $this->image = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : EntryTableMap::translateFieldName('Userid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->userid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : EntryTableMap::translateFieldName('Travelid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->travelid = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 9; // 9 = EntryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Entry'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aTravel !== null && $this->travelid !== $this->aTravel->getId()) {
            $this->aTravel = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aTravel !== null) {
                if ($this->aTravel->isModified() || $this->aTravel->isNew()) {
                    $affectedRows += $this->aTravel->save($con);
                }
                $this->setTravel($this->aTravel);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EntryTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'title';
        }
        if ($this->isColumnModified(EntryTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(EntryTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'time';
        }
        if ($this->isColumnModified(EntryTableMap::COL_LOCATION)) {
            $modifiedColumns[':p' . $index++]  = 'location';
        }
        if ($this->isColumnModified(EntryTableMap::COL_TEXT)) {
            $modifiedColumns[':p' . $index++]  = 'text';
        }
        if ($this->isColumnModified(EntryTableMap::COL_IMAGE)) {
            $modifiedColumns[':p' . $index++]  = 'image';
        }
        if ($this->isColumnModified(EntryTableMap::COL_USERID)) {
            $modifiedColumns[':p' . $index++]  = 'userid';
        }
        if ($this->isColumnModified(EntryTableMap::COL_TRAVELID)) {
            $modifiedColumns[':p' . $index++]  = 'travelid';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'userid':
                        ...
                        break;
                    case 'travelid':
                        $stmt->bindValue($identifier, $this->travelid, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aTravel) {
                ...
                $result[$key] = $this->aTravel->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EntryTableMap::COL_TITLE)) {
            $criteria->add(EntryTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(EntryTableMap::COL_DATE)) {
            $criteria->add(EntryTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(EntryTableMap::COL_TIME)) {
            $criteria->add(EntryTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(EntryTableMap::COL_LOCATION)) {
            $criteria->add(EntryTableMap::COL_LOCATION, $this->location);
        }
        if ($this->isColumnModified(EntryTableMap::COL_TEXT)) {
            $criteria->add(EntryTableMap::COL_TEXT, $this->text);
        }
        if ($this->isColumnModified(EntryTableMap::COL_IMAGE)) {
            $criteria->add(EntryTableMap::COL_IMAGE, $this->image);
        }
        if ($this->isColumnModified(EntryTableMap::COL_USERID)) {
            $criteria->add(EntryTableMap::COL_USERID, $this->userid);
        }
        if ($this->isColumnModified(EntryTableMap::COL_TRAVELID)) {
            $criteria->add(EntryTableMap::COL_TRAVELID, $this->travelid);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTravelid($this->getTravelid());
    ...
    /**
     * Declares an association between this object and a ChildTravel object.
     *
     * @param  ChildTravel $v
     * @return $this|\Entry The current object (for fluent API support)
     * @throws PropelException
     */
    public function setTravel(ChildTravel $v = null)
    {
        if ($v === null) {
            $this->setTravelid(NULL);
        } else {
            $this->setTravelid($v->getId());
        }

        $this->aTravel = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildTravel object, it will not be re-added.
        if ($v !== null) {
            $v->addEntry($this);
        }
    ...
    /**
     * Get the associated ChildTravel object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildTravel The associated ChildTravel object.
     * @throws PropelException
     */
    public function getTravel(ConnectionInterface $con = null)
    {
        if ($this->aTravel === null && ($this->travelid !== null)) {
            $this->aTravel = ChildTravelQuery::create()->findPk($this->travelid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTravel->addEntries($this);
             */
        }
     ...
     * If this ChildEntry is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildEntry The current object (for fluent API support)
     */
    ...
    {
        if (null !== $this->aUser) {
            $this->aUser->removeEntry($this);
        }
        if (null !== $this->aTravel) {
            $this->aTravel->removeEntry($this);
        }
        $this->id = null;
        $this->title = null;
        $this->date = null;
