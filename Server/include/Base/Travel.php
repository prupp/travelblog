...
/**
 * Base class that represents a row from the 'travel' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Travel implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TravelTableMap';
    ...
    /**
     * Initializes internal state of Base\Travel object.
     */
    ...
    /**
     * Compares this with another <code>Travel</code> instance.  If
     * <code>obj</code> is an instance of <code>Travel</code>, delegates to
     * <code>equals(Travel)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Travel The current object, for fluid interface
     */
     ...
     * @return $this|\Travel The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TravelTableMap::COL_ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[TravelTableMap::COL_TITLE] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d") !== $this->date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[TravelTableMap::COL_DATE] = true;
            }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[TravelTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setLength($v)
    {
        ...
        if ($this->length !== $v) {
            $this->length = $v;
            $this->modifiedColumns[TravelTableMap::COL_LENGTH] = true;
        }
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[TravelTableMap::COL_USERID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TravelTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TravelTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TravelTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TravelTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TravelTableMap::translateFieldName('Length', TableMap::TYPE_PHPNAME, $indexType)];
            $this->length = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TravelTableMap::translateFieldName('Userid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = TravelTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Travel'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTravelQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Travel::setDeleted()
     * @see Travel::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTravelQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TravelTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[TravelTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . TravelTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(TravelTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TravelTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'title';
        }
        if ($this->isColumnModified(TravelTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(TravelTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(TravelTableMap::COL_LENGTH)) {
            $modifiedColumns[':p' . $index++]  = 'length';
        }
        if ($this->isColumnModified(TravelTableMap::COL_USERID)) {
            $modifiedColumns[':p' . $index++]  = 'userid';
        }

        $sql = sprintf(
            'INSERT INTO travel (%s) VALUES (%s)',
    ...
    {
        $pos = TravelTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Travel'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Travel'][$this->hashCode()] = true;
        $keys = TravelTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(TravelTableMap::DATABASE_NAME);

        if ($this->isColumnModified(TravelTableMap::COL_ID)) {
            $criteria->add(TravelTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TravelTableMap::COL_TITLE)) {
            $criteria->add(TravelTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(TravelTableMap::COL_DATE)) {
            $criteria->add(TravelTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(TravelTableMap::COL_DESCRIPTION)) {
            $criteria->add(TravelTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(TravelTableMap::COL_LENGTH)) {
            $criteria->add(TravelTableMap::COL_LENGTH, $this->length);
        }
        if ($this->isColumnModified(TravelTableMap::COL_USERID)) {
            $criteria->add(TravelTableMap::COL_USERID, $this->userid);
        }
    ...
    {
        $criteria = ChildTravelQuery::create();
        $criteria->add(TravelTableMap::COL_ID, $this->id);
     ...
     * If this ChildTravel is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTravel The current object (for fluent API support)
     */
     ...
     * Otherwise if this Travel is new, it will return
     * an empty collection; or if this Travel has previously
     * been saved, it will retrieve related Entries from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Travel.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildEntry[] List of ChildEntry objects
     */
    public function getEntriesJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildEntryQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(TravelTableMap::DEFAULT_STRING_FORMAT);
    }
