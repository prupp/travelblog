 ...
 * @method     ChildUserQuery orderByRoleid($order = Criteria::ASC) Order by the roleid column
 * @method     ChildUserQuery orderByToken($order = Criteria::ASC) Order by the token column
 * @method     ChildUserQuery orderByExpire($order = Criteria::ASC) Order by the expire column
 *
 ...
 * @method     ChildUserQuery groupByRoleid() Group by the roleid column
 * @method     ChildUserQuery groupByToken() Group by the token column
 * @method     ChildUserQuery groupByExpire() Group by the expire column
 *
 ...
 *
 * @method     ChildUserQuery leftJoinEntry($relationAlias = null) Adds a LEFT JOIN clause to the query using the Entry relation
 * @method     ChildUserQuery rightJoinEntry($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Entry relation
 * @method     ChildUserQuery innerJoinEntry($relationAlias = null) Adds a INNER JOIN clause to the query using the Entry relation
 *
 * @method     ChildUserQuery leftJoinTicket($relationAlias = null) Adds a LEFT JOIN clause to the query using the Ticket relation
 * @method     ChildUserQuery rightJoinTicket($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Ticket relation
 * @method     ChildUserQuery innerJoinTicket($relationAlias = null) Adds a INNER JOIN clause to the query using the Ticket relation
 *
 * @method     ChildUserQuery leftJoinTravel($relationAlias = null) Adds a LEFT JOIN clause to the query using the Travel relation
 * @method     ChildUserQuery rightJoinTravel($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Travel relation
 * @method     ChildUserQuery innerJoinTravel($relationAlias = null) Adds a INNER JOIN clause to the query using the Travel relation
 *
 * @method     \RoleQuery|\CommentQuery|\EntryQuery|\TicketQuery|\TravelQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUser findOneByRoleid(int $roleid) Return the first ChildUser filtered by the roleid column
 * @method     ChildUser findOneByToken(string $token) Return the first ChildUser filtered by the token column
 * @method     ChildUser findOneByExpire(string $expire) Return the first ChildUser filtered by the expire column *
 ...
 * @method     ChildUser requireOneByRoleid(int $roleid) Return the first ChildUser filtered by the roleid column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUser requireOneByExpire(string $expire) Return the first ChildUser filtered by the expire column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUser[]|ObjectCollection findByRoleid(int $roleid) Return ChildUser objects filtered by the roleid column
 * @method     ChildUser[]|ObjectCollection findByToken(string $token) Return ChildUser objects filtered by the token column
 * @method     ChildUser[]|ObjectCollection findByExpire(string $expire) Return ChildUser objects filtered by the expire column
...
abstract class UserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, firstname, lastname, username, password, roleid, token, expire FROM user WHERE id = :p0';
        try {
    ...
    public function filterByRoleid($roleid = null, $comparison = null)
    {
        if (is_array($roleid)) {
            $useMinMax = false;
            if (isset($roleid['min'])) {
                $this->addUsingAlias(UserTableMap::COL_ROLEID, $roleid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($roleid['max'])) {
                $this->addUsingAlias(UserTableMap::COL_ROLEID, $roleid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserTableMap::COL_ROLEID, $roleid, $comparison);
    }
    ...
    public function filterByExpire($expire = null, $comparison = null)
    {
        if (is_array($expire)) {
            $useMinMax = false;
            if (isset($expire['min'])) {
                $this->addUsingAlias(UserTableMap::COL_EXPIRE, $expire['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($expire['max'])) {
                $this->addUsingAlias(UserTableMap::COL_EXPIRE, $expire['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserTableMap::COL_EXPIRE, $expire, $comparison);
    }
    ...
    public function filterByRole($role, $comparison = null)
    {
        if ($role instanceof \Role) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ROLEID, $role->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(UserTableMap::COL_ROLEID, $role->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByEntry($entry, $comparison = null)
    {
        if ($entry instanceof \Entry) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $entry->getUserid(), $comparison);
     ...
     *
     * @param \Ticket|ObjectCollection $ticket the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUserQuery The current query, for fluid interface
     */
    public function filterByTicket($ticket, $comparison = null)
    {
        if ($ticket instanceof \Ticket) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $ticket->getUserid(), $comparison);
        } elseif ($ticket instanceof ObjectCollection) {
            return $this
                ->useTicketQuery()
                ->filterByPrimaryKeys($ticket->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByTicket() only accepts arguments of type \Ticket or Collection');
        }
    }
     ...
     *
     * @param \Travel|ObjectCollection $travel the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUserQuery The current query, for fluid interface
     */
    public function filterByTravel($travel, $comparison = null)
    {
        if ($travel instanceof \Travel) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $travel->getUserid(), $comparison);
