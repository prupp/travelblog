...
abstract class Comment implements ActiveRecordInterface
{
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== null || $dt !== null) {
            if ($this->time === null || $dt === null || $dt->format("H:i:s") !== $this->time->format("H:i:s")) {
                ...
                $this->modifiedColumns[CommentTableMap::COL_TIME] = true;
            }
        } // if either are not null
    ...
    /**
     * Set the value of [entryid] column.
     *
     * @param int $v new value
     * @return $this|\Comment The current object (for fluent API support)
     */
    public function setEntryid($v)
    {
        ...
        if ($this->entryid !== $v) {
            $this->entryid = $v;
            $this->modifiedColumns[CommentTableMap::COL_ENTRYID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CommentTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CommentTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CommentTableMap::translateFieldName('Entryid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->entryid = (null !== $col) ? (int) $col : null;
            $this->resetModified();
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aEntry !== null && $this->entryid !== $this->aEntry->getId()) {
            $this->aEntry = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_TIME)) {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_ENTRYID)) {
            $modifiedColumns[':p' . $index++]  = 'entryid';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'userid':
                        ...
                        break;
                    case 'entryid':
                        $stmt->bindValue($identifier, $this->entryid, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aEntry) {
                ...
                $result[$key] = $this->aEntry->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_TIME)) {
            $criteria->add(CommentTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(CommentTableMap::COL_TEXT)) {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_ENTRYID)) {
            $criteria->add(CommentTableMap::COL_ENTRYID, $this->entryid);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setEntryid($this->getEntryid());
        if ($makeNew) {
            $copyObj->setNew(true);
    ...
    /**
     * Declares an association between this object and a ChildEntry object.
     *
     * @param  ChildEntry $v
     * @return $this|\Comment The current object (for fluent API support)
     * @throws PropelException
     */
    public function setEntry(ChildEntry $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildEntry object, it will not be re-added.
        if ($v !== null) {
            $v->addComment($this);
        }
    ...
    /**
     * Get the associated ChildEntry object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildEntry The associated ChildEntry object.
     * @throws PropelException
     */
    public function getEntry(ConnectionInterface $con = null)
    {
        if ($this->aEntry === null && ($this->entryid !== null)) {
            $this->aEntry = ChildEntryQuery::create()->findPk($this->entryid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEntry->addComments($this);
             */
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aEntry) {
            $this->aEntry->removeComment($this);
        }
        $this->id = null;
        $this->date = null;
        $this->time = null;
